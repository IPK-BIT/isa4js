...
> `optional` **derivesFrom?**: [`ISASourceSchema`](/isa4js/api/interfaces/isasourceschema/)[]
...
> `optional` **factorValues?**: [`ISAFactorValueSchema`](/isa4js/api/interfaces/isafactorvalueschema/)[]
